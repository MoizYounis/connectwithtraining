        ...
        if (count($course_list) > 0) {
            ...
            if (isset($data['design']) && $data['design'] != '') {
                ...
                foreach ($course_list as $course) {
                    ...
                    if (Helper::getRating($course->id)['star_rating'] >= 1) {
                        $html .= " checked";
                    }
                    $html .= '"></span>
                                                <span class="fa fa-star';
                    if (Helper::getRating($course->id)['star_rating'] >= 2) {
                        $html .= " checked";
                    }
                    $html .= '"></span>
                                                <span class="fa fa-star';
                    if (Helper::getRating($course->id)['star_rating'] >= 3) {
                        $html .= " checked";
                    }
                    $html .= '"></span>
                                                <span class="fa fa-star';
                    if (Helper::getRating($course->id)['star_rating'] >= 4) {
                        $html .= " checked";
                    }
                    $html .= '"></span>
                                                <span class="fa fa-star';
                    if (Helper::getRating($course->id)['star_rating'] >= 5) {
                        $html .= " checked";
                    }
                    $html .= '"></span>
											</div>
							...
							<div class="web-training-outer">
								...
								<div class="chat-outer">
									<ul>
										...
										<li class="price">
                                        <a herf="#" onclick="priceAddToCart(' . "'" . $course->course_name . "'" . ', ' . "'" . $course->id . "'" . ')" style="cursor:pointer;">
                            ...
                            <div class="web-training-outer">
                                <div class="after-img-part">
                                    <div class="left">
                                        <h2>' . ucwords($course->course_name) . '</h2>
                                        <p class="con">';
                    if (strlen($course->course_details) > 175) {
                        $html .= substr_replace($course->course_details, '...', 176);
                    } else {
                        $html .= $course->course_details;
                    }
                    $html .= '</p>
                                    </div>
                                    <div class="right">
    ...
    public static function getCartHtml()
    {
        ...
        if (count($cartData) > 0) {
            ...
            foreach ($cartData as $c) {
        									...
        									<div class="add-remove-box">
        										<div class="add-cart-item">
        											<div class="add-box add-all">
        												<a>
        													<span class=""><input type="checkbox" class="checkSingle"value="';
                ...
                $cart .= '"></span>
        													<span class="minus deleteItem" onclick="deleteFromCart(';
                if (Auth::user() !== null && !empty(Auth::user())) {
                    $cart .= "'" . $c->cid . "'";
                } else {
                    $cart .= "'" . $i . "'";
        								...
        								<td>
        									<div class="crt-rating">
        										<div class="rating-outer">
        											...
        											<div class="rating-star">
        												<span class="fa fa-star';
                if (Helper::getRating($c->id)['star_rating'] >= 1) {
                    $cart .= " checked";
                } else {
                    $cart .= "";
                }
                $cart .= '"></span>
                                                        <span class="fa fa-star';
                if (Helper::getRating($c->id)['star_rating'] >= 2) {
                    $cart .= " checked";
                } else {
                    $cart .= "";
                }
                $cart .= '"></span>
                                                        <span class="fa fa-star';
                if (Helper::getRating($c->id)['star_rating'] >= 3) {
                    $cart .= " checked";
                } else {
                    $cart .= "";
                }
                $cart .= '"></span>
                                                        <span class="fa fa-star';
                if (Helper::getRating($c->id)['star_rating'] >= 4) {
                    $cart .= " checked";
                } else {
                    $cart .= "";
                }
                $cart .= '"></span>
                                                        <span class="fa fa-star';
                if (Helper::getRating($c->id)['star_rating'] >= 5) {
                    $cart .= " checked";
                } else {
                    $cart .= "";
                }
        ...
        if (isset(Auth::user()->id) && Auth::user()->id != '') {
            ...
            if (count($fav) > 0) {
                ...
                foreach ($fav as $fav) {
                            						...
                            						<td>
                            							<div class="crt-rating">
                            								<div class="rating-outer">
                        										...
                        										<div class="rating-star">
                        											<span class="fa fa-star';
                    if (Helper::getRating($fav->id)['star_rating'] >= 1) {
                        $html .= " checked";
                    } else {
                        $html .= "";
                    }
                    $html .= '"></span>
                                                                    <span class="fa fa-star';
                    if (Helper::getRating($fav->id)['star_rating'] >= 2) {
                        $html .= " checked";
                    } else {
                        $html .= "";
                    }
                    $html .= '"></span>
                                                                    <span class="fa fa-star';
                    if (Helper::getRating($fav->id)['star_rating'] >= 3) {
                        $html .= " checked";
                    } else {
                        $html .= "";
                    }
                    $html .= '"></span>
                                                                    <span class="fa fa-star';
                    if (Helper::getRating($fav->id)['star_rating'] >= 4) {
                        $html .= " checked";
                    } else {
                        $html .= "";
                    }
                    $html .= '"></span>
                                                                    <span class="fa fa-star';
                    if (Helper::getRating($fav->id)['star_rating'] >= 5) {
                        $html .= " checked";
                    } else {
                        $html .= "";
                    }
