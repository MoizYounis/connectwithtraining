...
@section('title')Add Product | Products @endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('product.index')}}" class="btn btn-primary btn-sm float-right">Products List</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#product_import").addClass("active");
    });
</script>
@endsection