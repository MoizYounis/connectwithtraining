...
@section('title')Update Email Templates | Email Templates @endsection
@section('content')
      ...
      <!-- Breadcrumb-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="messages"></div>
                <div class="card">
                    <div class="card-header"><i class="zmdi zmdi-email"></i> Update Email Template</div>
                    <div class="card-body">
                        ...
                        <form class="my-5" method="post" action="{{route('emailTemplate.update', $et_edit->id)}}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control input-check" name="title" id="title" placeholder="Enter Email Template Title" value="{{$et_edit->title}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="form-group col-md-12">
                                ...
                                <textarea id="summernoteEditor" name="details" required="">{{$et_edit->details}}</textarea>
                              </div>
                            </div>                            
