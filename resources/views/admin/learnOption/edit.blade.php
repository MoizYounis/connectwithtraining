...
@section('title')Update Learning Options | Learning Options @endsection
@section('content')
      ...
      <!-- Breadcrumb-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="messages"></div>
                <div class="card">
                    <div class="card-header"><i class="zmdi zmdi-book"></i> Update Learning Options</div>
                    <div class="card-body">
                        <form method="post" action="{{route('learningOption.update', $lo_edit->id)}}">
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select style="width: 100%;" name="course_id" class="form-control input-check select2" id="course_id" required="">
                                  ...
                                  @foreach($course_list as $course)
                                      @if($lo_edit->course_id == $course->id)
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control input-check" name="learn_title" id="learn_title" placeholder="Enter Learn Option Title" required="" value="{{$lo_edit->learn_title}}" />
                            </div>

                            <div class="form-group col-md-12">
                              <label>Learn Option Description</label>
                              <textarea class="form-control input-check" name="learn_desc" id="learn_desc" placeholder="Enter Learn Option Description" required="" rows="5">{{$lo_edit->learn_desc}}</textarea>
                            </div>
