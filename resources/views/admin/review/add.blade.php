...
@section('title')Create Review | Review @endsection
@section('content')
      ...
      <!-- Breadcrumb-->
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void();"></a>Create Review</li>
                </ol>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="messages"></div>
                <div class="card">
                    <div class="card-header"><i class="zmdi zmdi-comment"></i> Create Review</div>
                    <div class="card-body">
                        <form method="post" action="{{route('review.store')}}">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-12">
                                <label>Comment*</label>
                                <textarea class="form-control input-check" name="comment" id="comment" placeholder="Enter Comment" required="" rows="5">{{old('comment')}}</textarea>
                              </div>
