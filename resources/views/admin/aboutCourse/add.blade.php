...
@section('title')Add About Course | Course @endsection
@section('content')
      ...
      <!-- Breadcrumb-->
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void();"></a>Create About Course</li>
                </ol>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="messages"></div>
                <div class="card">
                    <div class="card-header"><i class="zmdi zmdi-book"></i> Create About Course</div>
                    <div class="card-body">
                        <form method="post" action="{{route('aboutCourse.store')}}">
                            @csrf
                            <div class="row">
                              ...
                              <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control input-check" name="course_details" id="course_details" placeholder="Enter Details" required="" rows="5">{{old('course_details')}}</textarea>
                              </div>

                              <div class="form-group col-md-12">
                                <label>Course Goals</label>
                                <textarea id="summernoteEditor" name="course_goals">{{old('course_goals')}}</textarea>
                              </div>

                             <div class="form-group col-md-12">
                                <label>Course Difference</label>
                                <textarea class="form-control input-check" name="course_diff" id="course_diff" placeholder="Enter Difference" rows="5">{{old('course_goals')}}</textarea>
                              </div>
                              
                               <div class="form-group col-md-12">
                                <label>Project Management Pointers Description</label>
                                <textarea class="form-control input-check" name="pmp_desc" id="v" placeholder="Project Management Pointers Description" rows="5">{{old('pmp_desc')}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="row" id="inputFormRow">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control input-check" name="pointer_title[]" id="pointer_title" placeholder="Pointer Title">{{old('pointer_title')}}</textarea>
                                </div>

                                <div class="col-md-6">
                                    <label>Pointer Description</label>
                                    <textarea class="form-control input-check" name="pointer_desc[]" id="pointer_desc" placeholder="Pointer Description">{{old('pointer_desc')}}</textarea>
                                </div>
                            </div>
