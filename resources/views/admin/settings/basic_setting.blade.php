...
<div class="content p-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="{{route('update_basic_setting', $settings->general_settings_id)}}" method="post" enctype="multipart/form-data">
                @csrf

                <div class="row container-fluid">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="title" style="text-transform: uppercase;"><strong>Website Title

                            </strong></label>
                            <input class="form-control form-control-lg mb-3" name="title" value="{{$settings->title}}"  type="text">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>Site Base Color Code</strong></label>
                            <input class="form-control form-control-lg mb-3"  name="color_code" value="{{$settings->color_code}}" style="background:#{{ $settings->color_code }}" type="text">
                        </div>
                    </div>
                </div>
                <div class="row  container-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg mb-3" name="base_currency" value="{{$settings->base_currency}}"  type="text">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>Base Currency Symbol</strong></label>
                            <input class="form-control form-control-lg mb-3" name="base_currency_symbol" value="{{$settings->base_currency_symbol}}"  type="text">
                        </div>
                    </div>
