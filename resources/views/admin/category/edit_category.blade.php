...
@section('title')Edit Category | Categories @endsection
@section('content')
      ...
      <!-- Breadcrumb-->
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void();">Edit Category</a></li>
                </ol>
            </div>
         
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <a href="{{route('category.index')}}" class="btn btn-behance text-white btn-sm"> <i class="waves-effect waves-light add_data"></i> Category List </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="messages"></div>
                <div class="card">
                    <div class="card-header"><i class="zmdi zmdi-view-dashboard"></i> Update Category</div>
                    <div class="card-body">
                        <form method="post" action="{{route('category.update', [$category_edit->id])}}"  enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="row">
                              ...
                              <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control input-check" name="category_name" id="category_name" placeholder="Enter Category Name" value="{{$category_edit->category_name}}" required="">
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div style="margin-top: 10px;" id="image_file">
                                  ...
                                  <img src="{{asset('public/assets/front/img/category')}}/{{$category_edit->category_logo}}" style="width: 100px; width: 100px;" id="img">
                                </div>
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div style="margin-top: 10px;" id="image_file2">
                                  ...
                                  <img src="{{asset('public/assets/front/img/category_banner')}}/{{$category_edit->category_banner}}" style="width: 100px; width: 100px;" id="img2">
                                </div>
                              </div>
                              ...
                              <div class="form-group col-md-12">
                                <label>Status</label>
                                <select name="category_status" id="category_status" class="form-control select-check">
                                  <option value="">Choose Status</option>
                                  @if($category_edit->category_status == 'Active')
