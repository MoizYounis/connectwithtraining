                    ...
                    <form action="{{route('testimonial_update')}}" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-lg mb-3" name="general_settings_id" value="{{ $setting->general_settings_id}}"  type="hidden">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                    ...
                    <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img style="width: 100px;height: 100px;" class="thumbnail img-responsive" src="{{asset('public/assets/frontend/images/testimonial/'.$testimonial->testimonial_image)}}"/>
                                </td>
                                <td>
                                    {!! str_limit($testimonial->testimonial_comment, 15,'') !!}
                                    @if(str_word_count($testimonial->testimonial_comment) > 5)
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p><strong>{!! $testimonial->testimonial_comment !!}</strong></p>
                                                </div>
                                ...
                                <td>{{ $testimonial->testimonial_commentdesignation ?? 'No Information' }}</td>
                                <td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="form-control" id="comment" rows="2" name="comment">{{ $testimonial->testimonial_comment ?? old('comment') }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{route('storeNewTestimonial')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="image" class="col-sm-3 control-label bold uppercase"><strong>Image :</strong> </label>
                                                <div class="col-sm-12">
                                                    <input type="file" class="form-control has-error bold " id="image" name="testimonial_image">
                                                    <small class="text-danger h6">Image will be resize at 352*352 [Image format: JPG,JPEG]</small>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="col-sm-3 control-label bold uppercase"><strong>Name :</strong> </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control has-error bold " id="name" name="testimonial_name" placeholder="Full name">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="designation" class="col-sm-3 control-label bold uppercase"><strong>Designation :</strong></label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control has-error bold " id="designation" name="testimonial_designation" placeholder="Designation [ Optional ]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="comment" class="col-sm-3 control-label bold uppercase"><strong>Comment :</strong> </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control has-error bold " id="comment" name="testimonial_comment" placeholder="Comment">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
