            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row  container-fluid">
                    <div class="col-md-4">
                        ...
                        <img style="width: 100%;" class="thumbnail img-responsive" src="{{asset('public/assets/frontend/images/banner.jpg')}}"/>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <img style="width: 100%;" class="thumbnail img-responsive" src="{{asset('public/assets/frontend/images/features_slider.jpg')}}"/>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <img style="width: 100%;" class="thumbnail img-responsive" src="{{asset('public/assets/frontend/images/breadcrumb.jpg')}}"/>
                    </div>
                </div>
                <br>
                <div class="col-md-12">
