...
<div class="content p-4">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{route('service_info_update')}}" method="post">
                        @csrf
                    ...
                    <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! str_limit($services->service_details, 15,'') !!}
                                    @if(str_word_count($services->service_details) > 5)
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#commentDetails{{ $services->id }}">
                                        <i class="fa fa-eye"></i>  Details
                                    </button>
                                    <div class="modal fade" id="commentDetails{{ $services->service_id }}" role="dialog" aria-labelledby="#commentDetails" aria-hidden="true">
                        ...
                        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{route('stor_new_service')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="title" class="col-sm-3 control-label bold uppercase"><strong>Title :</strong> </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control has-error bold " id="title" name="service_title" value="{{ old('title') }}">
                                            ...
                                            <div class="form-group error">
                                                <label for="icon" class="col-sm-3 control-label bold uppercase"><strong>Icon Code :</strong> </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control has-error bold demo" id="icon" name="service_icon" placeholder="Services Fontawesome Code <i class='fa fa-facebook'></i>">
                                                    <small class="text-danger"><strong>For Fontawesome code visit : http://fontawesome.io/icons/</strong></small>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="details" class="col-sm-3 control-label bold uppercase"><strong>Details :</strong> </label>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control" id="details" rows="2" name="service_details">{{  old('details') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
