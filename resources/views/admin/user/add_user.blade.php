                        ...
                        <form action="{{url('admin/user/create')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control input-check" type="text" name="first_name"  value="{{old('first_name')}}" placeholder="First Name" id="first_name" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Last Name*</label>
                                        <input class="form-control input-check" type="text" name="last_name"  value="{{old('last_name')}}" placeholder="Last Name" id="technician_lname" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input class="form-control" type="number" name="phone"  value="{{old('phone')}}" placeholder="Phone Number" id="phone">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div style="margin-top: 10px;" id="image_file">
                                        @if(old('image'))
                                        <img src="{{asset('public/assets/front/img/user')}}/{{old('image')}}" id="img" style="width:100px; height:100px; object-fit:contain;">
                                        @endif
                                        <input type="hidden" name="image" id="image" value="
                                        @if(old('image')){{old('image')}} @endif" />
                                    </div>
                                </div>
                            </div>               
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="icheck-material-primary">                                        
                                        ...
                                        @if(old('status')) checked="" @else @endif
                                        />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email*</label>
                                        <input class="form-control input-check" type="text" name="email"  value="{{old('email')}}" placeholder="Email" id="email" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control input-check" type="password" name="password" placeholder="Password" value="" id="password" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="city"  value="{{old('city')}}" placeholder="City Name" id="city">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="state" placeholder="State Name" value="{{old('state')}}" id="State">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Pincode</label>
                                        <input class="form-control" type="number" name="pincode" placeholder="Pincode" value="{{old('pincode')}}" id="pincode">
                                    </div>
                                </div>
