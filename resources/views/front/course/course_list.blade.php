                    ...
                    <ul>
                        <li class="list-online-trng">
                            <a href="{{ url('courses/type/online') }}">
                                ...
                                <span class="title @if (Request::url() == url('courses/type/online')) title-active @endif">Online
                                    Training</span>
                            </a>
                        </li>
                        <li class="list-onsite-trng">
                            <a href="{{ url('courses/type/onsite') }}">
                                ...
                                <span class="title @if (Request::url() == url('courses/type/onsite')) title-active @endif">Onsite
                                    Classroom</span>
                            </a>
                        </li>
                        <li class="list-your-pace">
                            <a href="{{ url('courses/type/your-pace') }}">
                                ...
                                <span class="title @if (Request::url() == url('courses/type/your-pace')) title-active @endif">Your Pace</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="container">
                        <div class="left">
                            <div class="brows-drop">
                                <select id="category" style="padding: 0px 0px;" onfocus='this.size=8;'
                                    onblur='this.size=0;' onchange='this.size=1; this.blur();'
                                    class="select-category border">
                        ...
                        <div class="right">
                            ...
                            <div class="brows-drop pops-drop">
                                ...
                                <select class="selected-1 select-pops"
                                    style="background-color: white; color: #000; border: 1px solid grey !important; z-index: 10242 !important;"
                                    id="change-cat" name="2" onfocus='this.size=5;' onblur='this.size=0;'
                                    onChange="this.size=1; this.blur(); myFunction(this); filterCourse({courseStatus: this.options[this.selectedIndex].value}, '2', '.category-design-outer');">

                                    <option style="text-align: center;" value=""> &nbsp;&nbsp;&nbsp;Popular Today
                                    </option>
                    ...
                    <div class="container">
                        ...
                        <div class="category-design-outer">
                            @foreach ($category_data as $cat)
                                ...
                                if ($type) {
                                    $courses = \App\Model\Course::where('category_id', $cat->id)
                                        ->where('course_learning_status', $type)
                                        ->orderBy('id', 'DESC')
                                        ->get();
                                } else {
                                    $courses = \App\Model\Course::where('category_id', $cat->id)
                                                        ...
                                                        <div class="trn-top">
                                                            <div class="list-trn-top">
                                                                <div class="left">
                                                                    ...
                                                                    <div class="img-part">
                                                                        <img src="{{ asset('public/assets/front/img/course/' . $course->course_image) }}"
                                                                            alt="">
                                                                        <div class="ins">
                                                                        ...
                                                                        <a class="learn-more"
                                                                            href="{{ url('courses', str_replace(' ', '-', strtolower($course->course_name))) }}">Learn
                                                                            More</a>
                                                                        <div class="quick-links">
                                                                            <ul>
                                                                                <li class="watch">
                                                                                    <a
                                                                                        href="{{ url('courses', str_replace(' ', '-', strtolower($course->course_name))) }}">
                                                                                        <span class="icon"><i
                                                                                ...
                                                                                <li class="cart"
                                                                                    onclick="addToCart('{{ $course->course_name }}', '{{ $course->id }}')">
                                                                                ...
                                                                                <li class="favr"
                                                                                    onclick="addToFav('{{ $course->course_name }}', '{{ $course->id }}')">
                                                                                    <a href="javascript:void(0);">
                                                                                        <span class="icon"><i
                                                                                                class="fa fa-heart"></i></span>
                                                                                        <span
                                                                                            class="con">Favorite</span>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                ...
                                                                <div class="right">
                                                                    <div class="after-img-part">
                                                                        ...
                                                                        <div class="right">
                                                                            <div class="take-cours"><a
                                                                                    herf="javascript:void(0);"
                                                                                    class="cus-btn"
                                                                                    onclick="addToCart('<?= $course->course_name ?>','<?= $course->id ?>')">Take
                                                                                    Course</a></div>
                                                                            <div class="calender-date">
                                                                                <!--<img src="{{ asset('public/assets/front/images/start-date.jpg') }}" alt=""/>-->
                                                                                <div>
                                                                                    <div class="cal-month">
                                                                                        <h5>{{ date('F', strtotime($course->course_start_date)) }}
                                                                                        </h5>
                                                                                    </div>
                                                                                    <div class="cal-date">
                                                                                        <h2>{{ date('d', strtotime($course->course_start_date)) }}
                                                                                        </h2>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="rating-outer">
                                                                                <p class="rating-con">
                                                                                    <?= App\Helpers\Helper::getRating($course->id)['str'] ?>
                                                                                </p>
                                                                                <div class="rating-star">
                                                                                    <span
                                                                                        class="fa fa-star @if (App\Helpers\Helper::getRating($course->id)['star_rating'] >= 1) {{ 'checked' }} @endif"></span>
                                                                                    <span
                                                                                        class="fa fa-star @if (App\Helpers\Helper::getRating($course->id)['star_rating'] >= 2) {{ 'checked' }} @endif"></span>
                                                                                    <span
                                                                                        class="fa fa-star @if (App\Helpers\Helper::getRating($course->id)['star_rating'] >= 3) {{ 'checked' }} @endif"></span>
                                                                                    <span
                                                                                        class="fa fa-star @if (App\Helpers\Helper::getRating($course->id)['star_rating'] >= 4) {{ 'checked' }} @endif"></span>
                                                                                    <span
                                                                                        class="fa fa-star @if (App\Helpers\Helper::getRating($course->id)['star_rating'] >= 5) {{ 'checked' }} @endif"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="count-lec">
                                                                                <p>187 lectures</p>
                                                            ...
                                                            <div class="web-training-outer">
                                                                ...
                                                                <div class="chat-outer">
                                                                    <ul>
                                                                        <li class="chat-with">
                                                                            <a href="javascript:void(0);"
                                                                                data-modalId="{{ $course->id }}"
                                                                                class="openInsModal">Chat With
                                                                                Instructor</a>
                                                                        </li>
                                                                        <li class="price">
                                                                            <a herf="#"
                                                                                onclick="priceAddToCart('{{ $course->course_name }}' , '{{ $course->id }}')"
                                                                                ...
                                                                                <span
                                                                                    class="crunt-price">{{ Helper::changeCurrency($newPrice) }}</span>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                    <div class="radio-btn">
